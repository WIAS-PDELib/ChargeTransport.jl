...
nTilde_d0     =  0.0e-23*1e-6     # =0 means no nonlinearity, converges quickly
...
NC         = [  13.83,   0.77,   0.47,   0.77,  13.83 ] * 1e+24     / (m^3)
NV         = [  15.28,  14.23,  10.00,  14.23,  15.28 ] * 1e+24     / (m^3)
...
#layer thicknesses
heights       = [ 1.0000, 0.5000, 0.0500, 0.5000, 1.0000 ] * 1e-06           #vertical x5
#width of lateral regions
widths        = [ 10.0000,   2.0000,  10.0000 ] * 1e-6                       #horizontal

heightPoints  = [1.0, 1.5, 1.55, 2.05, 3.05] * 1e-6
widthPoints   = [1.0 ,1.2, 2.2 ]             * 1e-5
