...
### Added
- data.customReaction! : Where a user can pass a custom function which takes arguments f, u, node, data.
- data.paramsuser : Struct where user stores constants needed in function  data.customReaction!
